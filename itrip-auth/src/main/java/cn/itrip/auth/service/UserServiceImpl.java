...
public class UserServiceImpl implements UserService {
    ...
    public ItripUser findByUserCode(String userCode) {
        ...
        try {
            list = userMapper.getItripUserListByMap(map);
            if (list.size() > 0) {
                return list.get(0);
            }
        } catch (Exception e) {
    ...
    @Override
    public void creatUserByPhone(ItripUser user) throws Exception {
        //生成一个用户
    ...
    @Override
    public void creatUserByMail(ItripUser user) throws Exception {
        //生成激活码
